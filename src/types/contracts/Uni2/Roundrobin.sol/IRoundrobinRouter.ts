...
export interface IRoundrobinRouterInterface extends utils.Interface {
  functions: {
...
export interface IRoundrobinRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IRoundrobinRouterInterface;
