...
export interface I4iInterface extends utils.Interface {
  functions: {
...
export interface I4i extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: I4iInterface;
  ...
  AOfPool(_pool: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  estimateGas: {
    ...
    poolInfo(_pool: string, overrides?: CallOverrides): Promise<BigNumber>;
